...
class TestSpriteService:
    ...
    @pytest.mark.asyncio
    async def test_sprite_registry_read(self, ble_client, ble_services):
    ...
    @pytest.mark.asyncio
    async def test_sprite_operations_may_not_work(self, ble_client, ble_services):
