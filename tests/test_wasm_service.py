...
@pytest.mark.wasm
class TestWasmService:
    """WASM service tests"""
    
    def test_wasm_service_exists(self, ble_services):
        """Test WASM service is discovered"""
        services, characteristics = ble_services
        assert WASM_SERVICE_UUID in services
    
    def test_wasm_characteristics(self, ble_services):
    ...
    @pytest.mark.asyncio
    async def test_status_read(self, ble_client, ble_services):
    ...
    @pytest.mark.asyncio
    async def test_wasm_upload(self, ble_client, ble_services, serial_capture):
        ...
        with serial_capture:
            # Upload WASM file
            await self._upload_wasm(ble_client, upload_char, wasm_data)
    ...
    @pytest.mark.asyncio
    async def test_status_after_upload(self, ble_client, ble_services):
    ...
    @pytest.mark.asyncio
    async def test_get_answer_function(self, ble_client, ble_services, serial_capture):
    ...
    @pytest.mark.asyncio
    async def test_add_function(self, ble_client, ble_services, serial_capture):
    ...
    @pytest.mark.asyncio
    async def test_complete_wasm_workflow(self, ble_client, ble_services, serial_capture):
    ...
    async def _upload_wasm(self, ble_client, upload_char, wasm_data):
